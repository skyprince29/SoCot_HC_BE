...
INSERT INTO dbo.UserAccount (UserAccountId, Username, Password, PersonId, FacilityId, UserGroupId, RememberMeToken, IsOnline, IsinitLogin, IsActive, UserIdTemp, CreatedBy, CreatedDate, UpdatedBy, UpdatedDate) 
VALUES (NEWID(), 'SuperAdmin', '2d711642b726b04401627ca9fbac32f5c8530fb1903cc4db02258717921a4881', @PersonId, @FacilityId, 1, NULL, 1, 1, 1, NULL, '22222222-2222-2222-2222-222222222222', GETDATE(), '22222222-2222-2222-2222-222222222222', GETDATE());
