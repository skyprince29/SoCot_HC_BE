...
namespace SoCot_HC_BE.Migrations
{
    ...
    [Migration("20250422020158_Create_Patient")]
    partial class Create_Patient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoCot_HC_BE.Model.Household", b =>
                {
                    b.HasOne("SoCot_HC_BE.Model.Address", "HouseholdAddress")
                        .WithMany("HouseholdAddress")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoCot_HC_BE.Model.Person", "HoHPerson")
                        .WithMany("HouseholdWithHoHPerson")
                        .HasForeignKey("PersonIdHeadOfHousehold")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HoHPerson");
            ...
            modelBuilder.Entity("SoCot_HC_BE.Model.Patient", b =>
                {
                    b.HasOne("SoCot_HC_BE.Model.Person", "FatherPerson")
                        .WithMany("PatientsAsFather")
                        .HasForeignKey("PersonIdFather");

                    b.HasOne("SoCot_HC_BE.Model.Person", "MotherPerson")
                        .WithMany("PatientsAsMother")
                        .HasForeignKey("PersonIdMother");

                    b.HasOne("SoCot_HC_BE.Model.Person", "PatientPerson")
                        .WithMany("PatientsAsSelf")
                        .HasForeignKey("PersonIdPatient")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoCot_HC_BE.Model.Person", "SpousePerson")
            ...
            modelBuilder.Entity("SoCot_HC_BE.Model.Person", b =>
                {
                    b.HasOne("SoCot_HC_BE.Model.Address", "PermanentAddress")
                        .WithMany("PersonsWithPermanentAddress")
                        .HasForeignKey("AddressIdPermanent");

                    b.HasOne("SoCot_HC_BE.Model.Address", "ResidentialAddress")
            ...
            modelBuilder.Entity("SoCot_HC_BE.Model.Person", b =>
                {
                    b.Navigation("HouseholdWithHoHPerson");
